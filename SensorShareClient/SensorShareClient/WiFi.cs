...
namespace SensorShare.Compact
{
   public partial class SensorShareClient
   {
      ...
      //               sensorShareAP = preferredAPs.FindBySSID(SensorNetConfig.WiFiName);
      //               if (sensorShareAP == null)
      //               {
      //                  adapter.SetWirelessSettingsAddEx(SensorNetConfig.WiFiName, false, SensorNetConfig.WiFiKey, 1,
      ...
      //               else
      //               {
      //                  adapter.SetWirelessSettings(SensorNetConfig.WiFiName);
      //               }
      //            }
      //            catch (Exception ex)
      //            { }
